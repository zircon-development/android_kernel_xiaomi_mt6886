...
static u8 bq_fg_regs[NUM_REGS] = {
	0x00, 0x06, 0x08, 0x0C, 0x14, 0x0A, 0x16, 0x18, 0x12, 0x10, 0x2A, 0x2C,
	0x2E, 0x30, 0x32, 0x3C, 0x3E, 0x40, 0x60, 0x61,

	0x78, 0x79, 0x7B, 0x81, 0x83, 0x70, 0x71, 0x72, 0x85, 0x86, 0x87, 0x89,
	0x8B, 0x8D, 0xA1, 0xA3, 0xA5, 0xA7, 0xA9, 0x93, 0x94, 0x95, 0x97, 0x99,
};
...
struct mtk_bms_sysfs_field_info {
	...
	int (*set)(struct bq_fg_chip *gm, struct mtk_bms_sysfs_field_info *attr,
		   int val);
	int (*get)(struct bq_fg_chip *gm, struct mtk_bms_sysfs_field_info *attr,
		   int *val);
};
